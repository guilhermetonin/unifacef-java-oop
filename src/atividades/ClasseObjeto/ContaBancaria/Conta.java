package atividades.ClasseObjeto.ContaBancaria;
...
public class Conta {
    ...
    public void depositar(double valor) {
        if (this.status) {
            ...
            System.out.println("Não é possível. atividades.ClasseObjeto.ContaBancaria.Conta inativa.");
        }
    }
    ...
    public void encerrarConta() {
        if (this.status) {
            if (this.saldo == 0) {
                System.out.println("atividades.ClasseObjeto.ContaBancaria.Conta encerrada com sucesso.");
                this.status = !this.status ;
            } else {
                System.out.println("É preciso sacar todo o saldo para encerrar a conta.");
            }
        } else {
            System.out.println("atividades.ClasseObjeto.ContaBancaria.Conta inativa. Já está encerrada.");
        }
    }
